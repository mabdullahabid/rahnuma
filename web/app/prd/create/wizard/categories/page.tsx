        ...
        <div className="w-full md:w-64 bg-white rounded-lg shadow p-4">
          ...
          <div className="mt-8 pt-4 border-t">
            ...
            <div className="w-full bg-slate-200 rounded-full h-2.5 mb-4">
              <div className="bg-slate-700 h-2.5 rounded-full w-[40%]"></div>
            </div>
            <p className="text-sm text-slate-600">2 of 5 steps completed</p>
          </div>
        </div>
        ...
        <div className="flex-1 bg-white rounded-lg shadow p-6">
          ...
          <div className="mt-8 flex justify-between">
            <Link href="/prd/create/wizard">
              <Button variant="outline">Previous: User Roles</Button>
            </Link>
            <Link href="/prd/create/wizard/features">
              <Button>Next: Features</Button>
            </Link>
          </div>
        </div>
      </div>
